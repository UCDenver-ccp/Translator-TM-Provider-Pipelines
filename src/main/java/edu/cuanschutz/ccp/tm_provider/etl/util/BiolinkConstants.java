...
public class BiolinkConstants {
	...
	public enum BiolinkAssociation {
		...
		// TODO: need to define predicate to use for has_symptom relation
//		BL_DISEASE_TO_PHENOTYPIC_FEATURE(BL_DISEASE_TO_PHENOTYPIC_FEATURE_ASSOCIATION, new BiolinkPredicate[] {}),
...
//		BL_GENE_TO_DISEASE(BL_GENE_TO_DISEASE_ASSOCIATION,
//				new BiolinkPredicate[] { BiolinkPredicate.BL_CONTRIBUTES_TO, BiolinkPredicate.NO_RELATION_PRESENT }),
//
//		BL_GENE_TO_EXPRESSION_SITE(BL_GENE_TO_EXPRESSION_SITE_ASSOCIATION,
//				new BiolinkPredicate[] { BiolinkPredicate.BL_EXPRESSED_IN, BiolinkPredicate.NO_RELATION_PRESENT }),

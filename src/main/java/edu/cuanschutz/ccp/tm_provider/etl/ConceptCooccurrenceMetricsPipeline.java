...
public class ConceptCooccurrenceMetricsPipeline {
	...
	public static void main(String[] args) {
		...
		final PCollection<KV<String, Long>> conceptIdToCounts = getSingletonCountMapView(
				options.getSingletonFilePattern(), p);
		...
		final PCollectionView<Map<String, String>> conceptIdToCategoryMap = PCollectionUtil
				.fromTwoColumnFiles("category map", p, options.getCategoryMapFilePattern(),
						options.getCategoryMapFileDelimiter(), Compression.GZIP)
				.apply(View.<String, String>asMap());
	...
	public static PCollection<KV<String, Long>> getSingletonCountMapView(String singletonFilePattern, Pipeline p) {
		...
		PCollection<KV<String, String>> conceptIdToDocId = PCollectionUtil.fromTwoColumnFiles("singletons", p,
				singletonFilePattern, ConceptCooccurrenceCountsFn.OUTPUT_FILE_DELIMITER, Compression.UNCOMPRESSED);

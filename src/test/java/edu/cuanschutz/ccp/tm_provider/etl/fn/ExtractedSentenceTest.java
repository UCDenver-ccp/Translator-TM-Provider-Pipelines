...
//		assertEquals(expectedEs.getSentenceContext(), es.getSentenceContext());
	...
	@Test
	public void testGetSentenceWithUnderscoredEntities() {
		...
		String documentId = "PMID:31816576";
		String entityCoveredText2 = "TNF";
		String entityId2 = "PR:000016488";
		List<Span> entitySpan2 = Arrays.asList(new Span(150, 153));
		String entityPlaceholder2 = "@GENE$";

		String entityCoveredText1 = "nitric oxide";
		String entityId1 = "CHEBI:12345";
		List<Span> entitySpan1 = Arrays.asList(new Span(106, 118));
		String entityPlaceholder1 = "@CHEMICAL$";
		String keyword = "reduce";
...
//		assertEquals(expectedEs.getSentenceContext(), es.getSentenceContext());
		...
		assertEquals(expectedSentenceWithUnderscoredEntities, es.getSentenceTextWithUnderscoredEntities());

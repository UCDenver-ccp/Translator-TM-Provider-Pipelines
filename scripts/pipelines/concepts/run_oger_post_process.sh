...
then
  INPUT_DOC_CRITERIA="ACTIONABLE_TEXT|TEXT|${TEXT_PIPELINE_KEY}|${TEXT_PIPELINE_VERSION};AUGMENTED_TEXT|TEXT|${AUGMENTED_TEXT_PIPELINE_KEY}|${AUGMENTED_TEXT_PIPELINE_VERSION};CONCEPT_CIMAX|BIONLP|OGER|${OGER_PIPELINE_VERSION};CONCEPT_CIMIN|BIONLP|OGER|${OGER_PIPELINE_VERSION};CONCEPT_CS|BIONLP|OGER|${OGER_PIPELINE_VERSION}"
  ID_TO_OGER_DICT_ENTRY_MAP_FILE_PATH="${BUCKET}/ontology-resources/idToDictEntryMap.part1.tsv.gz"
else
  INPUT_DOC_CRITERIA="ACTIONABLE_TEXT|TEXT|${TEXT_PIPELINE_KEY}|${TEXT_PIPELINE_VERSION};AUGMENTED_TEXT|TEXT|${AUGMENTED_TEXT_PIPELINE_KEY}|${AUGMENTED_TEXT_PIPELINE_VERSION};CONCEPT_OGER_PP1|BIONLP|OGER_POST_PROCESS|${OGER_PP_PIPELINE_VERSION}"

...
then
	...
	INPUT_DOC_CRITERIA="ACTIONABLE_TEXT|TEXT|${TEXT_PIPELINE_KEY}|${TEXT_PIPELINE_VERSION};AUGMENTED_TEXT|TEXT|${AUGMENTED_TEXT_PIPELINE_KEY}|${AUGMENTED_TEXT_PIPELINE_VERSION};ABBREVIATIONS|BIONLP|ABBREVIATION|${ABBREV_PIPELINE_VERSION};CONCEPT_OGER_PP2|BIONLP|OGER_POST_PROCESS|${OGER_PP_PIPELINE_VERSION};CRF_CRAFT|BIONLP|CRF|${CRF_PIPELINE_VERSION};CRF_NLMDISEASE|BIONLP|CRF|${CRF_PIPELINE_VERSION}"
else
	INPUT_DOC_CRITERIA="ACTIONABLE_TEXT|TEXT|${TEXT_PIPELINE_KEY}|${TEXT_PIPELINE_VERSION};AUGMENTED_TEXT|TEXT|${AUGMENTED_TEXT_PIPELINE_KEY}|${AUGMENTED_TEXT_PIPELINE_VERSION};ABBREVIATIONS|BIONLP|ABBREVIATION|${ABBREV_PIPELINE_VERSION};CONCEPT_OGER_PP2|BIONLP|OGER_POST_PROCESS|${OGER_PP_PIPELINE_VERSION}"
fi

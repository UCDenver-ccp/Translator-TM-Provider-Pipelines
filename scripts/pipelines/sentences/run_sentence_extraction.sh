...
JAR_VERSION=${16}
OUTPUT_VERSION=${17}
OUTPUT_COLLECTION=${18} # sometimes we want the output directory be be a different name, e.g., bulk, than the collection name. This variable allows for that kind of customization. By default, it should be the same as the COLLECTION.
